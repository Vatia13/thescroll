...
function load_more_news(){
    ...
    if(!empty($_POST['cat'])){
        $args['category_name'] = ''.intval($_POST['cat']).'';
    }
...
add_action( 'wp_ajax_load_ajax_news', 'load_more_news' );
add_action( 'wp_ajax_nopriv_load_ajax_news', 'load_more_news' );