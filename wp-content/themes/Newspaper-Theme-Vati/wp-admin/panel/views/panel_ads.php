...
<?php echo td_panel_generator::box_start('Custom ad 4', false);?>


<!-- ad box code -->
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">YOUR CUSTOM AD 4</span>
        <p>Paste your ad code here. Google adsense will be made responsive automatically. <br><br> To add non adsense responsive ads, <br> <a target="_blank" href="http://forum.tagdiv.com/ads/">click here</a> (last paragraph)</p>
    </div>
    <div class="td-box-control-full">
        <?php
...
<?php echo td_panel_generator::box_start('Custom ad 5', false);?>


    <!-- ad box code -->
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">YOUR CUSTOM AD 5</span>
            <p>Paste your ad code here. Google adsense will be made responsive automatically. <br><br> To add non adsense responsive ads, <br> <a target="_blank" href="http://forum.tagdiv.com/ads/">click here</a> (last paragraph)</p>
        </div>
        <div class="td-box-control-full">
            <?php
