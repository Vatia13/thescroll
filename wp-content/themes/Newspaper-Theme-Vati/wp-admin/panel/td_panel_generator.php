...
class td_panel_generator {
    ...
    */
    ...
    static function color_piker($params_array) {
        //get control option
        if(!empty($params_array['selected_value'])) {
            $control_value = $params_array['selected_value'];
        } else {
        ...
        ?>
        <input type="text" value="<?php echo $control_value;?>" class="my-color-field" data-default-color="<?php echo $params_array['default_color'];?>" name="<?php echo self::generate_name($params_array);?>" />
